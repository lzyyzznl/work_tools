...
class FileRenamerBuilder:
    ...
    def __init__(self, debug_mode=False):
        ...
        self.entry_point = "apps/file_renamer/gui.py"
        self.output_dir = "dist"
        self.icon_path = "apps/file_renamer/resources/icon.ico"
    ...
    def build_executable(self):
        ...
        cmd = [
            ...
            "--remove-output",              # 清理旧输出
            "--include-data-dir=apps/file_renamer/resources=resources",  # 包含资源文件
    ...
    def run(self):
        ...
        if self.build_executable():
            ...
            if self.debug_mode:
                ...
                print("3. 根据错误信息修复问题")
                print("4. 修复后用正常模式重新构建: python scripts/nuitka_build_file_renamer.py")
        else:
...
def main():
    ...
    builder = FileRenamerBuilder(debug_mode=args.debug)
    builder.run()
