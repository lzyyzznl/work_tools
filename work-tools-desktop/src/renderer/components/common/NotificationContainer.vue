...
function getClassForType(type: string): string {
	const baseClasses =
		"flex items-start gap-3 min-w-80 max-w-120 p-4 rounded-lg shadow-lg cursor-pointer pointer-events-auto transition-all duration-200 hover:transform hover:-translate-y-0.5 hover:shadow-xl";
